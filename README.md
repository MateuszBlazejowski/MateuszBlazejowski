# Hi there 👋 I'm Mateusz Błażejowski!
...
| [AetherGrid](https://github.com/MateuszBlazejowski/AetherGrid) | AetherGrid is a retro-style, terminal-based multiplayer maze game inspired by classic roguelike adventures. Built for fans of deep, stat-driven gameplay, this game brings a nostalgic dungeon-crawling experience to your screen with complex inventory management, tactical combat, and real-time multiplayer exploration. Follows OOD principles, using design patterns. | C#, OOD, Design Patterns |
| [ Parkly](https://github.com/MateuszBlazejowski/ParklyBackend) | Backend application of a project aimed to develop an application for finding and booking parking spots in Warsaw. Part of a larger system of integrated renting applications. | Java, Rest API, Typescript, React |
